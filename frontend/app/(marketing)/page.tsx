...
export default function MarketingLandingPage() {
  return (
    <div className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      {/* Top Navigation */}
      <header className="relative z-10 flex h-16 w-full items-center justify-between border-b border-border/60 bg-background/70 backdrop-blur-md px-6 lg:px-12">
        <Link href="/" className="flex items-center gap-2.5">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground font-bold text-xs shadow-xs">
            P•AI
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-lg bg-primary text-primary-foreground text-xs font-bold hover:bg-primary/90 transition-all shadow-xs"
          >
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 pt-16 pb-20 text-center space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <Link
            href="/dashboard"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground text-sm font-bold hover:bg-primary/90 transition-all shadow-md"
          >
          ...
          <Link
            href="/teaching/pulse"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-border bg-card/80 backdrop-blur-md text-xs sm:text-sm font-semibold text-foreground hover:bg-muted transition-all"
          >
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-12">
        <div className="rounded-2xl border border-primary/30 bg-card/80 backdrop-blur-md p-8 sm:p-10 space-y-6 shadow-xl">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-border/80 pb-4">
            ...
            <span className="text-xs font-mono font-semibold text-emerald-600 dark:text-emerald-400 bg-emerald-500/10 px-2.5 py-1 rounded-md border border-emerald-500/20 w-fit">
              Demonstrated Case: CSE 3101
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 pt-2">
            <div className="p-4 rounded-xl border border-border/80 bg-background/80 space-y-2">
              <span className="font-mono text-xs font-bold text-primary">01 // INGESTION</span>
              <h3 className="text-xs font-bold text-foreground">Anonymous Exit Slips</h3>
            ...
            <div className="p-4 rounded-xl border border-border/80 bg-background/80 space-y-2">
              ...
              <h3 className="text-xs font-bold text-foreground">Direct vs AI Hypothesis</h3>
              <p className="text-[0.6875rem] text-muted-foreground leading-relaxed">
            ...
            <div className="p-4 rounded-xl border border-border/80 bg-background/80 space-y-2">
              ...
              <h3 className="text-xs font-bold text-foreground">3-Bullet Strategy</h3>
              <p className="text-[0.6875rem] text-muted-foreground leading-relaxed">
            ...
            <div className="p-4 rounded-xl border border-border/80 bg-background/80 space-y-2">
              ...
              <h3 className="text-xs font-bold text-foreground">Diagnostic Warm-Up</h3>
              <p className="text-[0.6875rem] text-muted-foreground leading-relaxed">
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-12 space-y-6">
        <div className="text-center space-y-2 max-w-2xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground">
            Designed under Swiss typographic restraint. No decorative neon, no unbacked claims.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 pt-4">
          {/* 1. Research Intelligence */}
          <div className="md:col-span-7 rounded-2xl border border-border bg-card/85 backdrop-blur-md p-6 space-y-4 shadow-sm flex flex-col justify-between">
          ...
          <div className="md:col-span-5 rounded-2xl border border-border bg-card/85 backdrop-blur-md p-6 space-y-4 shadow-sm flex flex-col justify-between">
            <div className="space-y-2">
          ...
          <div className="md:col-span-4 rounded-2xl border border-border bg-card/85 backdrop-blur-md p-6 space-y-4 shadow-sm flex flex-col justify-between">
            <div className="space-y-2">
          ...
          <div className="md:col-span-4 rounded-2xl border border-border bg-card/85 backdrop-blur-md p-6 space-y-4 shadow-sm flex flex-col justify-between">
            ...
            <Link
              href="/students/lor"
              className="inline-flex items-center gap-1.5 text-xs font-semibold text-purple-600 dark:text-purple-400 hover:underline pt-2"
            >
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-border/60 bg-card/60 backdrop-blur-md py-8 px-6 lg:px-12 text-xs text-muted-foreground flex flex-col sm:flex-row items-center justify-between gap-4">

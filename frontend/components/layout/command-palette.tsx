...
export function CommandPalette({ open, setOpen }: CommandPaletteProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-start justify-center pt-24 bg-background/70 backdrop-blur-sm animate-in fade-in-0 duration-150 p-4"
      ...
      >
        <Command className="flex flex-col w-full">
          ...
          <Command.List className="max-h-80 overflow-y-auto p-2">
            ...
            <Command.Group heading="Intelligence Workspaces" className="text-[0.6875rem] font-semibold text-muted-foreground px-2 py-1.5 uppercase tracking-wider">
              <Command.Item
                onSelect={() => navigateTo("/dashboard")}
                className="flex items-center gap-2.5 px-2.5 py-2 text-xs rounded-lg text-foreground hover:bg-muted cursor-pointer transition-colors"
              >
            ...
            <Command.Group heading="Data & System" className="text-[0.6875rem] font-semibold text-muted-foreground px-2 py-1.5 uppercase tracking-wider mt-2">
              <Command.Item
              ...
              <Command.Item
                ...
                className="flex items-center justify-between px-2.5 py-2 text-xs rounded-lg text-amber-600 dark:text-amber-400 hover:bg-amber-500/10 cursor-pointer transition-colors"
              >
          ...
          <div className="flex items-center justify-between border-t border-border px-3 py-2 text-[0.6875rem] text-muted-foreground bg-muted/30">
